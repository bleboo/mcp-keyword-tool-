...
- 키 5개 + 비밀주소 1개는 '환경변수'에서 읽음 (코드/깃허브엔 절대 안 들어감 = 안전)
  Render 대시보드의 Environment에 아래 6개를 등록하세요:
    NAVER_AD_API_KEY, NAVER_AD_SECRET_KEY, NAVER_AD_CUSTOMER_ID,
    NAVER_CLIENT_ID, NAVER_CLIENT_SECRET,
    MCP_SECRET_PATH   ← 이 도구의 비밀 주소(아무도 모르게 잠그는 열쇠)
"""
...
# 비밀 주소: 환경변수에서 읽음. 안 넣으면 기본값 "/mcp"로 (잠금 안 됨) 작동
